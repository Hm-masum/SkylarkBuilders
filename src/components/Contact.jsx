        ...
        <div className="md:flex justify-center items-center gap-4 my:4 lg:my-12">
            <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 rounded-lg">
                    <div data-aos="fade-right" className="border p-4 rounded-lg ">
                    ...
                    <div data-aos="fade-left" className="border p-4 rounded-lg">
                        <div className="flex space-x-7">
                            <div className="p-4 bg-blue-100 rounded-lg">
            ...
            <div data-aos="zoom-in">
                <img className="md:h-[500px] rounded-tr-[60px] rounded-bl-[60px]" src="https://i.ibb.co/QDrP540/pexels-binyamin-mellish-1396132.jpg" alt="" />
            </div>
        </div>
    );
};
